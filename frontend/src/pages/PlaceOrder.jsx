...
const PlaceOrder =  () => {
    const {navigate,backendUrl, token, cartItems, getCartAmount, delivery_fee, products, clearCart } = useContext(ShopContext);  
          ...
          switch(method){
            ...
            case "cod": {
              ...
              if(response.data.success){
                if (token) {
                  ...
                  } catch { /* ignore error, still clear frontend */ }
                }
                clearCart();
                navigate("/orders")
              }
            ...
            case "stripe": {
              ...
              if (responseStripe.data.success) {
                 window.location.href = responseStripe.data.success_url;
                 if (token) {
                  try {
                    await axios.post(backendUrl + "/api/cart/clear", {}, { headers: { Authorization: `Bearer ${token}` } });
            ...
            case "razorpay": {
              ...
              if (responseRazorpay.data.success) {
                const { order, orderId } = responseRazorpay.data;
    ...
    <form onSubmit={onSubmitHandler} className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t">
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        ...
        <div>
          ...
          <div required className=" flex flex-gap-3">
